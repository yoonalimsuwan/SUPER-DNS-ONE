# =============================================================================
# STRUCTURAL FOURIER NEURAL OPERATOR (SFNO 3D)  —  v2.2
...
class StructuralFNO3D(nn.Module):
    """
    Structural Fourier Neural Operator 3D  (v2.2)
    ...
    Pipeline:
        Lift (5→width) → N × StructuralFNOLayer(sigma, forcing_embed) → MCDropoutHead
    ...
    Args:
        ...
        forcing_channels  : number of external forcing components (v2.2;
                             ...
                             [ax,ay,az]; set to 0 to disable the forcing
                             path's parameters entirely if you know you
                             will never use it)
    ...
    def forward(
        ...
        Args:
            ...
            forcing_series : (B, forcing_channels, T) or None (v2.2) —
                ...
                SEISMIC ONE) covering the interval [0, t_target] this call
                predicts across. None reproduces exact v2.1 behaviour
                (ForcingFiLM becomes a no-op in every layer).
